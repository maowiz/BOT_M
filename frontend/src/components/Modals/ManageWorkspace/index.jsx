...
const noop = () => { };
const ManageWorkspace = ({ hideModal = noop, providedSlug = null, initialTab = "documents" }) => {
...
export function useManageWorkspaceModal() {
  ...
  const [initialTab, setInitialTab] = useState("documents");

  function showModal(tab = "documents") {
  ...
  return { showing, showModal, hideModal, initialTab };
}
