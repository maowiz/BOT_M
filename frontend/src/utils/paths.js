...
export default {
  ...
  github: () => {
    return "https://github.com/maowiz";
  },
  discord: () => {
    return "https://linkedin.com/in/muhammad-maowiz-saleem-0700272b1";
  },
  docs: () => {
    return "https://github.com/maowiz";
  },
  ...
  mailToMintplex: () => {
    return "mailto:maowiz@example.com";
  },
  hosting: () => {
    return "https://www.instagram.com/maowiz/";
  },
  workspace: {
    chat: (slug, options = {}) => {
